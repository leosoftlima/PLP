...
public class ChamadaProcedimento implements Comando {
	...
	public AmbienteExecucaoImperativa executar(AmbienteExecucaoImperativa amb)
		...
		/*
		 * o incrementa e o restaura neste ponto servem para criar as variveis que serao
	...
	/**
	 * insere no contexto o resultado da associacao entre cada parametro formal e
	 * seu correspondente parametro atual
	 */
	...
	/**
	 * Realiza a verificacao de tipos desta chamada de procedimento, onde os tipos
	 * dos parametros formais devem ser iguais aos tipos dos parametros reais na
